...
print(maximumElementAfterDecrementingAndRearranging(arr = [2,2,1,2,1]))
print(maximumElementAfterDecrementingAndRearranging(arr = [100,1,1000]))
print(maximumElementAfterDecrementingAndRearranging(arr = [1,2,3,4,5]))
