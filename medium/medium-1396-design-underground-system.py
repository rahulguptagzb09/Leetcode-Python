...
undergroundSystem = UndergroundSystem()
print(undergroundSystem.checkIn(10, "Leyton", 3))
print(undergroundSystem.checkOut(10, "Paradise", 8))
print(undergroundSystem.getAverageTime("Leyton", "Paradise"))
print(undergroundSystem.checkIn(5, "Leyton", 10))
print(undergroundSystem.checkOut(5, "Paradise", 16))
print(undergroundSystem.getAverageTime("Leyton", "Paradise"))
print(undergroundSystem.checkIn(2, "Leyton", 21))
print(undergroundSystem.checkOut(2, "Paradise", 30))
print(undergroundSystem.getAverageTime("Leyton", "Paradise"))
